...
export const statusConfig: Record<RecipeStatus, { text: string; badge: string; icon: LucideIcon }> = {
  ...
  [RecipeStatus.SentToExternal]: { text: 'Enviada Recetario', badge: 'bg-cyan-100 text-cyan-800 border-cyan-200', icon: Send },
  [RecipeStatus.Preparation]: { text: 'En Preparación', badge: 'bg-cyan-100 text-cyan-800 border-cyan-200', icon: FlaskConical },
  [RecipeStatus.ReceivedAtSkol]: { text: 'Recepcionado Skol', badge: 'bg-orange-100 text-orange-800 border-orange-200', icon: PackageCheck },
