...
import type { AppData, Patient, Doctor, Recipe, InventoryItem, User, Role, ExternalPharmacy, PharmacovigilanceReport, ControlledSubstanceLogEntry, DispatchNote, MonthlyDispensationBox, PatientMessage, AppSettings } from './types';
...
const patients: Patient[] = [
    { id: 'pat-01', name: 'Gaspar Mendoza', rut: '11.111.111-1', email: 'gaspar.mendoza@email.com', phone: '+56987654321', gender: 'Masculino', address: 'Av. Siempre Viva 742, Santiago', isChronic: true, proactiveStatus: ProactivePatientStatus.OK, proactiveMessage: 'No requiere acción.', actionNeeded: PatientActionNeeded.NONE, allergies: ['Penicilina'], commercialMedications: ['Aspirina 100mg'] },
    { id: 'pat-02', name: 'Lucía Fernández', rut: '22.222.222-2', email: 'lucia.fernandez@email.com', phone: '+56912345678', gender: 'Femenino', address: 'Pasaje El Roble 123, Providencia', isChronic: true, proactiveStatus: ProactivePatientStatus.OK, proactiveMessage: 'No requiere acción.', actionNeeded: PatientActionNeeded.NONE, allergies: [], commercialMedications: ['Losartan 50mg', 'Metformina 850mg'], adverseReactions: [{ medication: 'Enalapril', description: 'Tos seca persistente' }] },
...
const externalPharmacies: ExternalPharmacy[] = [
    { id: 'ext-ph-01', name: 'Farmacias Magistrales Central', contactPerson: 'Sofía Lara', email: 'contacto@magistralcentral.cl', phone: '+56212345678', defaultPaymentModel: 'Por Receta', transportCost: 3500 },
    { id: 'ext-ph-02', name: 'Recetario Alameda', contactPerson: 'Roberto Gómez', email: 'rgomez@recetarioalameda.cl', phone: '+56287654321', defaultPaymentModel: 'Factura Mensual', transportCost: 5000 },
];

// --- INVENTORY ---
const inventory: InventoryItem[] = [
    {
        id: 'inv-001', name: 'Minoxidil 5%', activePrinciple: 'Minoxidil', sku: 'ISP-F-123', manufacturer: 'Laboratorio Chile', pharmaceuticalForm: 'Solución Tópica', doseValue: 5, doseUnit: '% p/v', itemsPerBaseUnit: 90, saleCondition: 'Receta Simple', isControlled: false, requiresRefrigeration: false,
        unit: 'frasco', quantity: 500, lowStockThreshold: 100, costPrice: 8000, salePrice: 15000, lots: [{ lotNumber: 'MX202401', quantity: 500, expiryDate: addMonths(new Date(), 12).toISOString() }]
    },
    {
        id: 'inv-002', name: 'Fenobarbital 100mg', activePrinciple: 'Fenobarbital', sku: 'ISP-F-456', manufacturer: 'Bayer', pharmaceuticalForm: 'Comprimido', doseValue: 100, doseUnit: 'mg', itemsPerBaseUnit: 30, saleCondition: 'Receta Cheque', isControlled: true, controlledType: 'Psicotrópico', requiresRefrigeration: false,
        unit: 'caja', quantity: 10, lowStockThreshold: 5, costPrice: 15000, salePrice: 22000, lots: [{ lotNumber: 'FB202312', quantity: 10, expiryDate: addMonths(new Date(), 6).toISOString() }]
    },
    {
        id: 'inv-003', name: 'Clonazepam 2mg', activePrinciple: 'Clonazepam', sku: 'ISP-F-789', manufacturer: 'Andrómaco', pharmaceuticalForm: 'Comprimido', doseValue: 2, doseUnit: 'mg', itemsPerBaseUnit: 30, saleCondition: 'Receta Retenida', isControlled: true, controlledType: 'Psicotrópico', requiresRefrigeration: false,
        unit: 'caja', quantity: 19, lowStockThreshold: 10, costPrice: 8000, salePrice: 12500, lots: [{ lotNumber: 'CZ202402', quantity: 19, expiryDate: addMonths(new Date(), 24).toISOString() }]
    },
    {
        id: 'inv-004', name: 'Crema Base Hidratante', activePrinciple: 'Base Galénica', sku: 'N/A', manufacturer: 'Genérico', pharmaceuticalForm: 'Crema', doseValue: 100, doseUnit: '%', itemsPerBaseUnit: 1000, saleCondition: 'Venta Directa',
        unit: 'pote', quantity: 5, lowStockThreshold: 2, costPrice: 20000, salePrice: 30000, lots: [{ lotNumber: 'CB202403', quantity: 5, expiryDate: addMonths(new Date(), 18).toISOString() }]
    },
    {
        id: 'inv-005', name: 'Aspirina 100mg', activePrinciple: 'Ácido Acetilsalicílico', sku: 'ISP-F-101', manufacturer: 'Bayer', pharmaceuticalForm: 'Comprimido', doseValue: 100, doseUnit: 'mg', itemsPerBaseUnit: 30, saleCondition: 'Venta Directa', isControlled: false, requiresRefrigeration: false,
        unit: 'caja', quantity: 50, lowStockThreshold: 10, costPrice: 2000, salePrice: 3500, lots: [{ lotNumber: 'AS202405', quantity: 50, expiryDate: addMonths(new Date(), 12).toISOString() }]
    },
    {
        id: 'inv-006', name: 'Losartan 50mg', activePrinciple: 'Losartan Potásico', sku: 'ISP-F-102', manufacturer: 'Mintlab', pharmaceuticalForm: 'Comprimido', doseValue: 50, doseUnit: 'mg', itemsPerBaseUnit: 30, saleCondition: 'Receta Simple', isControlled: false, requiresRefrigeration: false,
        unit: 'caja', quantity: 30, lowStockThreshold: 10, costPrice: 4000, salePrice: 6000, lots: [{ lotNumber: 'LS202406', quantity: 30, expiryDate: addMonths(new Date(), 18).toISOString() }]
    },
    {
        id: 'inv-007', name: 'Metformina 850mg', activePrinciple: 'Metformina Clorhidrato', sku: 'ISP-F-103', manufacturer: 'Laboratorio Chile', pharmaceuticalForm: 'Comprimido', doseValue: 850, doseUnit: 'mg', itemsPerBaseUnit: 30, saleCondition: 'Receta Simple', isControlled: false, requiresRefrigeration: false,
        unit: 'caja', quantity: 5, lowStockThreshold: 10, costPrice: 3500, salePrice: 5500, lots: [{ lotNumber: 'MT202407', quantity: 5, expiryDate: addMonths(new Date(), 24).toISOString() }]
    },
];
...
const patientMessages: PatientMessage[] = [
    ...
    { id: 'msg-03', patientId: 'pat-01', sender: 'pharmacist', content: 'Estamos hasta las 19:00 hrs. ¡Te esperamos!', createdAt: subMinutes(subDays(today, 1), -15).toISOString(), read: true },
];

const appSettings: AppSettings = {
    id: 'global',
    pharmaceuticalForms: [
        'Cápsulas', 'Crema', 'Solución', 'Gel', 'Ungüento', 'Comprimidos', 'Gotas', 'Inyectable', 'Otro'
    ],
    concentrationUnits: [
        '% p/p', '% p/v', '% v/v', 'mg/mL', 'g/mL', 'mcg/mL', 'UI/mL', 'mg/g', 'g/g', 'mg', 'g', 'mcg', 'UI', 'mg/dosis', 'mcg/dosis', 'mg/gota', 'Otro'
    ],
    dosageUnits: [
        'cápsula(s)', 'comprimido(s)', 'gragea(s)', 'papelillo(s)', 'mL', 'gota(s)', 'cucharadita(s) (5mL)', 'cucharada(s) (15mL)', 'aplicación(es)', 'gramo(s)', 'UI', 'parche(s)', 'óvulo(s)', 'supositorio(s)', 'puff(s)', 'inhalación(es)', 'nebulización(es)', 'frasco(s)', 'unidad(es)', 'Otro'
    ],
    treatmentDurationUnits: ['días', 'semanas', 'meses'],
    quantityToPrepareUnits: [
        'cápsula(s)', 'comprimido(s)', 'gragea(s)', 'sachet(s)', 'papelillo(s)', 'mL', 'L', 'gramo(s)', 'Kg', 'frasco(s)', 'pote(s)', 'tubo(s)', 'blister(s)', 'caja(s)', 'unidad(es)', 'Otro'
    ],
};
