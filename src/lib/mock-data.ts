...
const inventory: InventoryItem[] = [
    { id: 'inv-001', name: 'Minoxidil 5% (Base)', unit: 'g', lowStockThreshold: 100, quantity: 500, costPrice: 50, salePrice: 100, lots: [{ lotNumber: 'MX202401', quantity: 500, expiryDate: addMonths(new Date(), 12).toISOString() }], itemsPerBaseUnit: 1, activePrincipleContentValue: 5, activePrincipleContentUnit: '%' },
    { id: 'inv-002', name: 'Fenobarbital 100mg (Caja 30 comps)', unit: 'caja', lowStockThreshold: 5, quantity: 10, costPrice: 15000, salePrice: 22000, isControlled: true, controlledType: 'Psicotrópico', lots: [{ lotNumber: 'FB202312', quantity: 10, expiryDate: addMonths(new Date(), 6).toISOString() }], itemsPerBaseUnit: 30, activePrincipleContentValue: 100, activePrincipleContentUnit: 'mg' },
    { id: 'inv-003', name: 'Clonazepam 2mg (Caja 30 comps)', unit: 'caja', lowStockThreshold: 10, quantity: 19, costPrice: 8000, salePrice: 12500, isControlled: true, controlledType: 'Psicotrópico', lots: [{ lotNumber: 'CZ202402', quantity: 19, expiryDate: addMonths(new Date(), 24).toISOString() }], itemsPerBaseUnit: 30, activePrincipleContentValue: 2, activePrincipleContentUnit: 'mg' },
    { id: 'inv-004', name: 'Crema Base Hidratante', unit: 'kg', lowStockThreshold: 2, quantity: 5, costPrice: 20000, salePrice: 30000, lots: [{ lotNumber: 'CB202403', quantity: 5, expiryDate: addMonths(new Date(), 18).toISOString() }] },
    { id: 'inv-005', name: 'Aspirina 100mg (Caja 30 comps)', unit: 'caja', lowStockThreshold: 10, quantity: 50, costPrice: 2000, salePrice: 3500, lots: [{ lotNumber: 'AS202405', quantity: 50, expiryDate: addMonths(new Date(), 12).toISOString() }] },
    { id: 'inv-006', name: 'Losartan 50mg (Caja 30 comps)', unit: 'caja', lowStockThreshold: 10, quantity: 30, costPrice: 4000, salePrice: 6000, lots: [{ lotNumber: 'LS202406', quantity: 30, expiryDate: addMonths(new Date(), 18).toISOString() }] },
    { id: 'inv-007', name: 'Metformina 850mg (Caja 30 comps)', unit: 'caja', lowStockThreshold: 10, quantity: 5, costPrice: 3500, salePrice: 5500, lots: [{ lotNumber: 'MT202407', quantity: 5, expiryDate: addMonths(new Date(), 24).toISOString() }] },
];
