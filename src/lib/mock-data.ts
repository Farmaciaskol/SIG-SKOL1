...
const recipes: Recipe[] = [
  { id: 'rec-1', patientId: 'pat-1', doctorId: 'doc-1', items: recipeItemsSample1, status: RecipeStatus.Dispensed, paymentStatus: 'Pagado', createdAt: formatISO(subDays(now, 45)), updatedAt: formatISO(subDays(now, 40)), dueDate: formatISO(addMonths(subDays(now, 45), 6)), externalPharmacyId: 'ext-pharma-1', supplySource: 'Stock del Recetario Externo', preparationCost: 15000 },
  { id: 'rec-2', patientId: 'pat-2', doctorId: 'doc-1', items: recipeItemsSample2, status: RecipeStatus.Preparation, paymentStatus: 'Pendiente', createdAt: formatISO(subDays(now, 5)), updatedAt: formatISO(subDays(now, 2)), dueDate: formatISO(addMonths(subDays(now, 5), 6)), externalPharmacyId: 'ext-pharma-2', supplySource: 'Stock del Recetario Externo', preparationCost: 25000 },
  { id: 'rec-3', patientId: 'pat-7', doctorId: 'doc-4', items: recipeItemsSample3, status: RecipeStatus.Validated, paymentStatus: 'Pendiente', createdAt: formatISO(subDays(now, 1)), updatedAt: formatISO(subDays(now, 1)), dueDate: formatISO(addMonths(subDays(now, 1), 6)), externalPharmacyId: 'ext-pharma-1', supplySource: 'Insumos de Skol', skolSuppliedItemsDispatchStatus: SkolSuppliedItemsDispatchStatus.PendingDispatch, preparationCost: 18000 },
  { id: 'rec-4', patientId: 'pat-3', doctorId: 'doc-2', items: recipeItemsSample1, status: RecipeStatus.PendingValidation, paymentStatus: 'Pendiente', createdAt: formatISO(subDays(now, 0)), updatedAt: formatISO(subDays(now, 0)), dueDate: formatISO(addMonths(subDays(now, 0), 6)), externalPharmacyId: 'ext-pharma-3', supplySource: 'Stock del Recetario Externo', preparationCost: 16000 },
  { id: 'rec-5', patientId: 'pat-4', doctorId: 'doc-3', items: recipeItemsSample2, status: RecipeStatus.QualityControl, paymentStatus: 'Pagado', createdAt: formatISO(subDays(now, 10)), updatedAt: formatISO(subDays(now, 3)), dueDate: formatISO(addMonths(subDays(now, 10), 6)), externalPharmacyId: 'ext-pharma-2', supplySource: 'Stock del Recetario Externo', preparationCost: 22000 },
  { id: 'rec-6', patientId: 'pat-5', doctorId: 'doc-2', items: recipeItemsSample1, status: RecipeStatus.Rejected, rejectionReason: 'Firma de médico no coincide', paymentStatus: 'N/A', createdAt: formatISO(subDays(now, 12)), updatedAt: formatISO(subDays(now, 11)), dueDate: formatISO(addMonths(subDays(now, 12), 6)), externalPharmacyId: 'ext-pharma-1', supplySource: 'Stock del Recetario Externo', preparationCost: 0 },
  { id: 'rec-7', patientId: 'pat-1', doctorId: 'doc-1', items: recipeItemsSample2, status: RecipeStatus.Cancelled, paymentStatus: 'N/A', createdAt: formatISO(subDays(now, 30)), updatedAt: formatISO(subDays(now, 20)), dueDate: formatISO(addMonths(subDays(now, 30), 6)), externalPharmacyId: 'ext-pharma-3', supplySource: 'Stock del Recetario Externo', preparationCost: 0 },
];
