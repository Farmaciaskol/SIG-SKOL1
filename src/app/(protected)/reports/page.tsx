...
const ReportCard = ({ title, description, icon: Icon, actionText, onAction, disabled = false }: { title:string, description: string, icon: React.ElementType, actionText: string, onAction: () => void, disabled?: boolean }) => (
      ...
      <div>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <ReportCard 
                ...
                actionText="Generar CSV (Próximamente)"
                onAction={() => handleGenerateReport('Informe de Inventario')}
                disabled={true}
            />
             <ReportCard 
                ...
                onAction={() => handleGenerateReport('Informe Financiero')}
                disabled={true}
            />
             <ReportCard 
                ...
                onAction={() => handleGenerateReport('Libro de Control de Sustancias')}
                disabled={true}
            />
             <ReportCard 
                ...
                onAction={() => handleGenerateReport('Análisis por Médico')}
                disabled={true}
            />
        </div>
      </div>
