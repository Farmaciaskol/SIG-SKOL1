  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "flex h-full w-[--sidebar-width] flex-col bg-muted text-card-foreground",
            className
          )}
          ref={ref}
          {...props}
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-muted p-0 text-card-foreground [&>button]:hidden border-r-0"
            style={
              {
          ...
          >
            <SheetHeader className="sr-only">
              ...
              <SheetDescription>
                Main application navigation and options.
              </SheetDescription>
            </SheetHeader>
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "duration-200 fixed top-0 bottom-0 z-10 hidden h-auto w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex",
            side === "left"
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-muted border-r-0 group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-border group-data-[variant=floating]:shadow"
          >
            {children}
          </div>
        </div>
