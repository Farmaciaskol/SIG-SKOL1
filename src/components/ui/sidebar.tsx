      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-muted p-0 text-card-foreground [&>button]:hidden"
            style={
              {
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-auto items-center px-2 pt-3 pb-1 text-xs font-medium uppercase tracking-wider text-muted-foreground",
