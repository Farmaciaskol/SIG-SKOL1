            ...
            <CardHeader className="p-4">
              <div className="flex items-start justify-between gap-2">
                ...
                <div className="flex items-center gap-1 shrink-0">
                  ...
                  {recipe.status === RecipeStatus.Validated && recipe.supplySource === 'Insumos de Skol' && (<TooltipProvider><Tooltip><TooltipTrigger asChild><span><Truck className="h-4 w-4 text-orange-600" /></span></TooltipTrigger><TooltipContent><p>Pendiente de Despacho a Recetario</p></TooltipContent></Tooltip></TooltipProvider>)}
                </div>
              </div>
            </CardHeader>
